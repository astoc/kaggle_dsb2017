...
if __name__ == '__main__':
    ...
    model_load_name = '../luna/models/d8g4a_model_65.h5'
    model_save_name = '../luna/models/d8g4a_model_67.h5'  ### MUST include "_model" string as we use this for a substituion for weights file

    seed = 65000 # should be varied by steps/stages
    downsample = 1
    set_lr_value = False
