...
if __name__ == '__main__':
    ...
    model_load_name = '../luna/models/d8g_bre_model_16.h5'
    model_save_name = '../luna/models/d8g_bre_model_18.h5'  ### MUST include "_model" string as we use this for a substituion for weights file
           
    seed = 16000 # should be varied by steps/stages
